...
--data '{"attachments": [{"text": "'"$IDS_JOB_NAME"' - '"$SLACK_MSG"' - Project: '"$IDS_PROJECT_NAME"'. Deployment Target: '"$DEPLOY_TARGET"'","color": "#3AA3E3","actions": [{"name": "game","text": "LOGS","type": "button","url": "'"$LOGS_URL"'"}]}]}' \
$SLACK_WEBHOOK
