...
curl -v POST --data-urlencode 'payload={"channel": "#'"$OWNER_SLACK_CHANNEL"'", "username": "DevX Skit Monitor", "text": "'"$TEXT"'", "attachments": [{"name": "game","text": "LOGS","type": "button","url": "'"$LOGS_URL"'"}], "icon_emoji": ":terminator:"}' \
$SLACK_WEBHOOK
